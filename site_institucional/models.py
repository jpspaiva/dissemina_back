...
class Servicos(models.Model):
    image = models.ImageField(verbose_name='Imagem Servicos', upload_to='servicos')
    titulo = models.CharField(verbose_name='Titulo Servicos', max_length=250)
    subtitulo = models.CharField(verbose_name='Subtitulo Servicos', max_length=250)
...
class Portfolio(models.Model):
    image = models.ImageField(verbose_name='Imagem Portifolio', upload_to='portifolio')
    titulo = models.CharField(verbose_name='Titulo Portifolio', max_length=250)
    subtitulo = models.CharField(verbose_name='Subtitulo Portifolio', max_length=250)
...
class Depoimentos(models.Model):
    image = models.ImageField(verbose_name='Imagem Depoimentos', upload_to='depoimentos')
    titulo = models.CharField(verbose_name='Titulo Depoimentos', max_length=250)
    cliente = models.CharField(verbose_name='Nome Cliente', max_length=250)
    ocupcliente = models.CharField(verbose_name='Ocupacao Cliente', max_length=20)
